...
#     modnlp.Defaults.stop_words = {"un","una","unos","unas","el","los","la","las","lo","yo","mi","conmigo","me","nosotros","nosotras","nos","tú","usted","ti","contigo","ustedes","él","ella","ello","si","consigo","lo","a","ante","bajo","con","contra","de","desde","durante","en","entre","hacia","hasta","mediante","para","por","según","sin","sobres","tras","ni","tanto","como","o","bien","y","sino","también","pero","ya","para","mientras","luego"}
